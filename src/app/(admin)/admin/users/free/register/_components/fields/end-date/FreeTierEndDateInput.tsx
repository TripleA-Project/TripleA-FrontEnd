...
import { freeTierEndDateRules } from './freeTierEndDateRules';
import dayjs from 'dayjs';
import 'dayjs/locale/ko';

function FreeTierEndDateInput() {
  const { control } = useFormContext<FreeTrialFormData>();
  const { field, fieldState } = useController({ control, name: 'freeTierEndDate', rules: freeTierEndDateRules });
...
export default FreeTierEndDateInput;
