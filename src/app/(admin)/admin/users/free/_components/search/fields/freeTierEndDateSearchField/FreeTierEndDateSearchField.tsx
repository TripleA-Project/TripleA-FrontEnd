...
import { searchFreeTierEndDateRules } from './freeTierEndDateRules';
...
function FreeTierEndDateSearchField() {
  const {
    control,
    formState: { isSubmitting },
  } = useFormContext<FreeTierUserSearchFormData>();
  const { field } = useController({ control, name: 'freeTierEndDate', rules: searchFreeTierEndDateRules });
...
export default FreeTierEndDateSearchField;
