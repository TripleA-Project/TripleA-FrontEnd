...
function Home() {
  ...
  <div>
    ...
    <CardNews newsId={news.newsId} symbol={news.symbol} source={news.source} title={news.title} description={news.description} thumbnail={news.thumbnail} publishedDate={news.publishedDate} sentiment={news.sentiment} bookmark={news.bookmark}/>  
    <CardNews newsId={news.newsId} symbol={news.symbol} source={news.source} title={news.title} description={news.description} thumbnail={news.thumbnail} publishedDate={news.publishedDate} sentiment={news.sentiment} bookmark={news.bookmark}/>  
  </div>
    )
}
