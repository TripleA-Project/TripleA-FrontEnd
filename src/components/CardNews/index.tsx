  ...
  return (
    <>
      <Card className='rounded-2xl bg-white' cardDirection={cardDirection} sentimentColor={sentimentColor}>
        ...
        <div className='row'>
          <ChipContainer symbol={symbol} logo={logo}/>
          <News title={title} source={source} publishedDate={publishedDate} sentimentColor={sentimentColor} hole1={<NewsImage thumbnail={thumbnail} cardDirection={cardDirection}/>} hole2={<ButtonContainer bookmark={bookmark} newsId={newsId}/>} cardDirection={cardDirection}/>
        </div>
        :
        <>
