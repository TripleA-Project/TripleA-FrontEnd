...
import type { IChartApi, ISeriesApi, LineData, LogicalRange, MouseEventParams } from 'lightweight-charts';
...
interface SymbolChartContainerProps {
  chartApiList: ChartApiList;
  children: React.ReactNode;
}

function SymbolChartContainer({ chartApiList, children }: SymbolChartContainerProps) {
