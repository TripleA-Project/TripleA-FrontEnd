...
function SymbolFormUnauthorized() {
  return (
    <FitPage>
      <div className="flex h-full w-full items-center justify-center">
        <div className="flex w-full flex-col items-center justify-center rounded-lg border-transparent bg-white px-4 py-8 drop-shadow-[0_-4px_4px_rgba(0,0,0,0.06)]">
          ...
          <div className="my-6 text-center">
            ...
            <p className="text-xl font-semibold text-[#4E525D]">심볼 수정이 가능합니다</p>
          </div>
          <Link href="/login?continueURL=/mypage/edit/symbol">
...
export default SymbolFormUnauthorized;
