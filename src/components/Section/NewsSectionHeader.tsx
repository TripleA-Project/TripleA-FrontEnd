...
export default function NewsSectionHeader({ type,icon, sectionTitle}:NewsSectionHeaderProps) {
  ...
  return (
    <div className='relative grid grid-cols-[1fr_9fr_1.5fr] items-center px-0 py-[25px]'>
      ...
      <div>
        {type !=='column' && <SectionHeaderButtonContainer icons={[<HamburgerIcon key='1' />,<GridIcon key='2'/>]}/>}
      </div>
    </div>
  )
}
