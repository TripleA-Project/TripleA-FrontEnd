  ...
  return (
    <div>
      ...
      <section className="my-8">
        ...
        <ol className="box-border list-decimal px-5">
          <li>이름, 아이디(이메일 주소), 비밀번호, 휴대폰 번호(유료결재시 필요)는 필수로 수집합니다.</li>
      ...
      <section className="my-8">
        ...
        <ul className="box-border list-disc px-5">
          <li>이용자가 사전에 동의한 경우</li>
          <li>법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우</li>
          <li>통계작성, 학술연구나 시장조사를 위해 특정 개인을 식별할 수 없는 형태로 가공해 제공하는 경우</li>
          <li>
            이용자가 사전에 동의한 경우 회사는 편리하고 더 나은 서비스를 제공하기 위해 정해진 범위 내에서 개인정보를
            위탁해 처리합니다.
          </li>
          <li>결제 처리: 나이스페이먼츠(주), 카카오페이</li>
          <li>서비스 제공을 위한 서버 운영: AWS(Amazon Web Services, Inc.)</li>
          <li>
            이용되는 개인정보 항목은 구독관리 솔루션 제공업체인 스텝페이(https://www.steppay.kr/)에 계정 이메일 주소,
            이름, 핸드폰번호 등 유료 구독관리 정보와 유료구독 관리에 필요한 서비스 이용 기록에 한함.
          </li>
        </ul>
      </section>
      <section className="my-8">
      ...
      <section className="my-8">
        ...
        <address className="box-border px-5">
          <ul className="list-disc">
            <li>이름: 박혜정</li>
      ...
      <section className="my-8">
        ...
        <p>이 개인정보 처리방침은 2023년 8월 1일부터 적용됩니다.</p>
        <p>개인정보 처리방침 버전번호: 1.0</p>
        <p>
          공고일자: <time>2023년 8월 1일</time>
        </p>
        <p>
          시행일자: <time>2023년 8월 1일</time>
        </p>
      </section>
    </div>
  );
